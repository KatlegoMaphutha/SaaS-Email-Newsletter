...
import { ICONS } from "@/shared/utilis/icons";
        ...
        <Button
          ...
          onClick={() =>
            handleSubscription({
              price:
                active === "Monthly"
                  ? "price_1PI8fVHS8RznqVKaYlvahqrO"
                  : "price_1PI8kIHS8RznqVKaNGKb4PfO",
            })
          }
        >
          Get Started
        ...
        <Button
          ...
          onClick={() =>
            handleSubscription({
              price:
                active === "Monthly"
                  ? "price_1PKydDHS8RznqVKaGc1o9lpK"
                  : "price_1PI8imHS8RznqVKavZrgmjdB",
            })
          }
        >
          Get Started
